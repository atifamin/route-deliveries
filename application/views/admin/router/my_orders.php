                  ...
                  <div class="col-md-12"> 
                    ...
                    <div class="portlet light ">
                      <div class="portlet-title">
                        <div class="caption font-dark"> <i class="icon-settings font-dark"></i> <span class="caption-subject bold uppercase"> My Orders </span> </div>
                      </div>
                      <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                          ...
                          <tbody>
                            <?php if($router_active_orders->num_rows()>0){ ?>
                            <?php foreach($router_active_orders->result() as $orders){ ?>
                            <tr class="odd gradeX">
					...
					?>
                              ...
                              <td><a href="<?php echo site_url("router/my_orders/order_status/".$orders->id); ?>" class="btn btn-xs red dropdown-toggle"> Add Order Status </a></td>
