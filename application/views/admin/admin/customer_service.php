                  ...
                  <div class="col-md-12"> 
                    ...
                    <div class="portlet light ">
                      <div class="portlet-title">
                        <div class="caption font-dark"> <i class="icon-settings font-dark"></i> <span class="caption-subject bold uppercase"> Customer Service Inquiries</span> </div>
                      </div>
                      <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                          ...
                          <tbody>
                            <?php if($customer_service->num_rows()>0){ ?>
                            <?php foreach($customer_service->result() as $inquiry){ ?>
                            <tr class="odd gradeX">
                              <td><?php echo $inquiry->id; ?></td>
                              <td><?php echo $inquiry->order_number; ?></td>
                              <td><?php echo $inquiry->first_name; ?></td>
                              <td><?php echo $inquiry->last_name; ?></td>
                              <td><?php echo $inquiry->email; ?></td>
                              <td><a data-toggle="modal" href="#basic" class="btn btn-icon-only green" onClick="load_inquiry(<?php echo $inquiry->id; ?>)" ><i class="fa fa-arrows-alt"></i></a> <a href="<?php echo site_url("admin1/customer_service/delete/".$inquiry->id); ?>" class="btn btn-icon-only red confirm_delete" ><i class="fa fa-times"></i></a></td>
                            </tr>
                            <?php }} ?>
                          </tbody>
                        </table>
...
function load_inquiry(id){
	$.post("<?php echo site_url("admin1/customer_service/get_by_id"); ?>", {id:id}).done(function(data){
		//console.log(data);
