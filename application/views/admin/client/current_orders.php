...
<div class="container-fluid">
  ...
  <div class="c-layout-sidebar-content "> 
    ...
    <div class="c-content-title-1">
      <h3 class="c-font-uppercase c-center c-font-bold">Current Orders</h3>
        ...
        <div class="row">
          <div class="col-md-12">
            <table class="table table-striped">
              ...
              <tbody>
                <?php if($order_detail->num_rows>0){ ?>
                <?php foreach($order_detail->result() as $orders){ ?>
                <tr>
...
function get_order(order_id){
	$.post("<?php echo site_url("client/current_orders/get_order"); ?>",{order_id:order_id}).done(function(data){
