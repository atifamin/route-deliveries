...
<?php } ?>
<div class="c-content-box c-size-md c-bg-img-top c-bg-parallax" style="background-image: url(<?php echo base_url("assets/base/img/content/backgrounds/main_background.jpg")?>); padding: 60px 0 15px 0 !important;">
  <div class="container">
    <div class="c-content-feature-11">
    <div class="row">
        <div class="col-md-8 c-grid" data-auto-height="true" data-related="#c-video-card-3">
          <div class="c-singup-form">
            ...
            <form class="form-inline" action="<?php echo base_url("create_order"); ?>" method="post" enctype="multipart/form-data" id="lets_route_form">
              ...
              <button type="button" class="btn btn-lg btn-danger c-btn-uppercase c-btn-square c-btn-bold" onclick="lets_route()" >Let's Route</button>
            </form>
          </div>
          </div>
        <div class="col-md-4"> <img src="<?php echo base_url("assets/base/img/content/backgrounds/pull_down_screen.png")?>" style="width:60%; " class="img-responsive mobile_picture" /> </div>
      </div>
      </div>
    </div>
  </div>
...
<div class="c-content-box c-size-md c-bg-white">
    <div class="container">
        <div class="c-content-title-1 c-center c-margin-t-80 wow animate fadeInUp">
            <div class="row">
...
<div class="c-content-box c-size-md c-bg-white">
  <div class="container">
  <h1 class="c-center c-font-uppercase c-font-bold">What can i have delivered</h1>
  <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:809px;height:150px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:809px;height:150px;overflow:hidden;">
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-1.png")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-2.png")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-3.png")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-4.jpg")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-5.jpg")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-6.jpg")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-7.jpg")?>" />
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url("assets/base/img/content/client-logos/pic-8.jpg")?>" />
            </div>
        </div>
        <!-- Bullet Navigator -->
...
<div class="c-content-box c-size-md c-bg-img-top" style="background-image: url(<?php echo base_url("assets/base/img/content/backgrounds/bg-84.jpg")?>)">
  <div class="container" align="center" style="padding-left:2%">
    <div class="col-md-3 col-sm-3"> <a href="#"> <img src="<?php echo base_url("assets/base/img/layout/logos/The_Boston_Globe.svg.png")?>" alt="" class="img-responsive" /> </a> </div>
    <div class="col-md-3 col-sm-3" style="width:10%"> <a href="#"> <img src="<?php echo base_url("assets/base/img/layout/logos/cnbc_logo.png")?>" alt="" class="img-responsive" style="width:55%;"  /> </a> </div>
    <div class="col-md-3 col-sm-3"> <a href="#"> <img src="<?php echo base_url("assets/base/img/layout/logos/The_New_York_Times_logo.png")?>" alt="" class="img-responsive"  /> </a> </div>
    <div class="col-md-3 col-sm-3"> <a href="#"> <img src="<?php echo base_url("assets/base/img/layout/logos/WSJ_Logo.svg.png")?>" alt="" class="img-responsive"  /> </a> </div>
  </div>
</div>
